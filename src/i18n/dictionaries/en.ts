...
const en: Dictionary = {
  ...
  templates: {
    ...
    description:
      "Choose a design, make it yours, and go live in just a few hours. Production-ready templates — customized, branded, and launched fast.",
    pageTitle: "Website Templates",
    pageDescription:
      "Browse our full collection of production-ready website templates. Filter by category, preview live sites, and request the one that fits your brand.",
    ...
    empty: "No templates match this category yet.",
  },
  language: {
    label: "Language",
  ...
  contact: {
    ...
    templateInquirySubject: "Ready-to-Go Template request — {id}",
    submit: "Send message",
    sending: "Sending…",
    success:
