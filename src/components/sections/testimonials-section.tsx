    ...
    <section className="border-t border-border/60 bg-muted/20 py-20 sm:py-28">
      <div className="container space-y-14">
        <SectionHeading
          ...
          description="What founders and product leaders say after shipping with us."
        />
        ...
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {testimonials.map((item) => (
            ...
            >
              <div className="flex gap-0.5 text-amber-400" aria-label={`${item.rating} out of 5 stars`}>
